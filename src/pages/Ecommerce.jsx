        ...
        >
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-2xl">123 456,-Kč</p>
            </div>
          </div>
          <div className="mt-6">
            <Button
        ...
        >
          ...
          <div
            className="mt-10 flex 
                      gap-10 flex-wrap justify-center"
          >
            <div className="border-r-1 border-color m-4 pr-10">
              <div>
                <p>
                  <span className="text-3xl font-semibold">12 568,-Kč</span>
                  <span
                    className="p-1.5 
                    hover:drop-shadow-xl cursor-pointer
              ...
              <div className="mt-8">
                <p>
                  <span className="text-3xl font-semibold">20 568,-Kč</span>
                </p>
